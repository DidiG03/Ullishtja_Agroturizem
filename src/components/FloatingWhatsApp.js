...
const WHATSAPP_NUMBER = '355684090405';
...
function FloatingWhatsApp({ currentLanguage = 'al', t }) {
  const copy = t?.whatsappFloat || FALLBACK[currentLanguage] || FALLBACK.al;
  ...
  const handleClick = useCallback(() => {
    ...
    integratedAnalyticsService.trackWhatsAppClick(currentLanguage);
  }, [currentLanguage]);
  ...
  return (
    ...
    >
      ...
      <span className="floating-whatsapp__label">{copy.label}</span>
    </a>
  );
}
